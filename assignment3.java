...
public class assignment3 {
    ...
    private static void findWorkers(Scanner scanner) {
        ...
        for (Worker worker : workersList) {
            if (worker.getFullName().toLowerCase().contains(keyword) || worker.getMail().toLowerCase().contains(keyword)) {
                matches.add(worker);
            }
        }
...
class Worker {
    ...
    public String toString() {
        return "ID: " + workerId + ", Name: " + fullName + ", Email: " + mail + ", Age: " + yearsOld + ", DOB: " + birthDate;
    }
}
