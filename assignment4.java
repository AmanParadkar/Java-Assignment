...
class BankAccount {
    ...
    public void withdraw(int amount, String user) {
        if (currentBalance >= amount) {
            ...
            System.out.println(user + " attempted to withdraw ₹" + amount + " but insufficient funds. Balance: ₹" + currentBalance);
        }
    }
...
public class assignment4 {
    ...
    private static void simulateUnsafeTransactions() {
        ...
        try { user1.join(); user2.join(); } catch (InterruptedException e) { }
    }
